...
__all__ = [
    ...
    'SAFTADPCM_22kHzMono', 'DISPID_SpeechVoice', 'DISPID_SGRName',
    'SPAR_Medium', 'SPSUnknown', 'DISPID_SRCResume', 'SRSInactive',
    'DISPID_SPRDisplayAttributes', 'SP_VISEME_19', 'SVEWordBoundary',
    ...
    'DISPID_SVSyncronousSpeakTimeout', 'SITooSlow', 'SLTUser',
    'SVSFParseSsml', 'SVF_None', 'SpeechAudioState',
    'eLEXTYPE_PRIVATE11', 'DISPID_SPIElements', 'DISPID_SBSFormat',
    '_ISpeechRecoContextEvents', 'DISPID_SPIRule',
    'DISPID_SRGCmdLoadFromResource', 'SpeechStreamSeekPositionType',
    'SpeechVoiceCategoryTTSRate', 'SRSActive', 'SRTEmulated',
    'ISpRecoGrammar', 'DISPID_SLPType', 'SPVOICESTATUS',
    ...
    'SP_VISEME_20', 'SP_VISEME_13', 'SAFT16kHz8BitStereo',
    'STCLocalServer', 'eLEXTYPE_RESERVED7',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SRProfile',
    'SpeechEngineProperties', 'ISpeechTextSelectionInformation',
    ...
    'DISPID_SRCreateRecoContext', 'DISPID_SPCPhoneToId',
    'SVSFNLPMask', 'SPCATEGORYTYPE', 'SPVPRI_OVER',
    'eLEXTYPE_PRIVATE2', 'SDTLexicalForm', 'eLEXTYPE_PRIVATE14',
    'SpStream', 'SPEVENTENUM', 'ISpeechPhraseElement',
    'ISpRecognizer2', 'SPPS_Noncontent', 'ISpeechPhraseRule',
    'SPEI_START_SR_STREAM', 'SRTSMLTimeout', 'DISPID_SPEDisplayText',
    ...
    'SpCompressedLexicon', 'DISPID_SpeechRecoResultTimes',
    'SRAORetainAudio', 'DISPID_SLPSymbolic', 'STCInprocHandler',
    'DISPID_SDKCreateKey', 'eLEXTYPE_PRIVATE15', 'SP_VISEME_17',
    'ISpObjectTokenCategory', 'SpeechGrammarTagDictation',
    'DISPID_SVEStreamStart', 'SPFM_NUM_MODES', 'DISPID_SVSpeak',
    'SPEI_SR_AUDIO_LEVEL', 'SpeechDictationTopicSpelling',
    'SDKLCurrentConfig', 'DISPID_SVEAudioLevel', 'SPCONTEXTSTATE',
    'DISPID_SGRsFindRule', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SOTCreateInstance', 'DISPID_SPIEnginePrivateData',
    'SVP_18', 'SREInterference', 'ISpeechBaseStream',
    'ISpeechAudioBufferInfo', 'SWTAdded', 'SVEAudioLevel',
    'DISPID_SFSClose', 'DISPID_SAFGuid', 'ISpeechObjectTokens',
    'DISPID_SPPId', 'SPSHT_EMAIL', 'SpeechBookmarkOptions',
    'DISPID_SLGetPronunciations', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SPPHRASEELEMENT', 'SAFT22kHz8BitStereo', 'DISPID_SpeechAudio',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'DISPID_SPEsCount',
    'ISpeechGrammarRuleState', 'DISPID_SPPs_NewEnum', 'SP_VISEME_9',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SGDSActive',
    'ISpShortcut', 'SPGRAMMARWORDTYPE', 'SPWF_SRENGINE',
    'DISPID_SRGCmdLoadFromObject', 'DISPIDSPRG', 'ISpEventSink',
    'DISPID_SRRRecoContext', 'SP_VISEME_5', 'SPWORDLIST',
    'DISPID_SRGDictationSetState', 'SP_VISEME_2',
    'SAFT12kHz16BitMono', 'SPDATAKEYLOCATION',
    'DISPID_SRGetRecognizers', 'DISPID_SREmulateRecognition',
    'SpeechEngineConfidence', 'SRESoundStart', 'eLEXTYPE_PRIVATE7',
    'DISPID_SRCCreateGrammar', 'SP_VISEME_15', 'SDTAlternates',
    'SAFT32kHz16BitMono', 'SPVPRI_NORMAL',
    'DISPID_SGRSTPropertyValue', 'SPLO_STATIC', 'DISPID_SASState',
    'DISPID_SRAudioInput', 'DISPID_SPEAudioStreamOffset',
    'DISPID_SASetState', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SVP_15', 'SPEI_SR_PRIVATE', 'SPCS_DISABLED',
    'DISPID_SPAs_NewEnum', 'SREAudioLevel', 'eLEXTYPE_RESERVED8',
    'DISPID_SVGetAudioOutputs', 'SpeechRuleState',
    'DISPID_SOTCDefault', 'DISPID_SOTDataKey',
    'DISPID_SVSLastBookmark', 'SSTTDictation', 'SDKLCurrentUser',
    ...
    'eLEXTYPE_PRIVATE8', 'DISPID_SWFEBlockAlign', 'DISPID_SVRate',
    'DISPID_SGRSTRule', 'SVPAlert', 'DISPID_SRRTStreamTime',
    'SPPS_RESERVED3', 'DISPID_SPEAudioSizeTime', 'DISPID_SOTSetId',
    'DISPID_SpeechPhraseAlternate', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SPRuleConfidence', 'DISPID_SPIGrammarId',
    'SpUnCompressedLexicon', 'eLEXTYPE_PRIVATE10',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SDKEnumValues',
    ...
    'SREStreamEnd', 'DISPID_SGRSTsCount', 'SRTExtendableParse',
    'DISPID_SABIBufferSize', 'SGSEnabled',
    ...
    'DISPID_SRCERecognition', 'SPBO_AHEAD', 'DISPID_SPIStartTime',
    'SpeechVisemeFeature', 'SAFTADPCM_44kHzStereo', 'SRTReSent',
    'SWPUnknownWordUnpronounceable', 'ISpeechRecoResultDispatch',
    'SVP_1', 'DISPID_SVEWord', 'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SRRAudioFormat', 'SPCT_DICTATION',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SLPsCount', 'SVSFlagsAsync',
    'DISPID_SVResume', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SPEI_RESERVED5', 'SPWT_DISPLAY', 'SECFEmulateResult',
    'DISPID_SAEventHandle', 'DISPID_SPAStartElementInResult',
    'DISPID_SPRules_NewEnum', 'DISPID_SPCIdToPhone',
    'SPEI_START_INPUT_STREAM', 'SPEI_PHRASE_START', 'SPFILEMODE',
    'STCInprocServer', 'SAFTDefault', 'SAFTCCITT_uLaw_8kHzStereo',
    'SPXRO_SML', '__MIDL_IWinTypes_0009', 'SpeechCategoryAudioOut',
    'SpeechVoiceSpeakFlags', 'DISPID_SPPParent', 'DISPID_SOTsCount',
    'SAFT48kHz16BitMono', 'SASStop', 'DISPID_SpeechLexiconProns',
    'SpeechWordPronounceable', 'ISpeechDataKey', 'SAFT8kHz8BitMono',
    'SGRSTTWord', 'SPWORDPRONOUNCEABLE', 'SPXRO_Alternates_SML',
    'DISPID_SDKDeleteValue', 'DISPID_SpeechRecoResult',
    'ISpeechRecoResult', 'SGRSTTDictation',
    'DISPID_SRSSupportedLanguages', 'ISpeechPhraseInfoBuilder',
    'DISPID_SPEActualConfidence', 'ISpeechVoice',
    'SECFNoSpecialChars', 'SDTProperty', 'SAFT24kHz8BitStereo',
    'SDA_Two_Trailing_Spaces', 'SPPHRASE',
    'ISpeechObjectTokenCategory', 'SECHighConfidence',
    'SpeechTokenShellFolder', 'DISPID_SPIProperties', 'SITooQuiet',
    'DISPID_SOTCSetId', 'SRSInactiveWithPurge', 'SSFMCreateForWrite',
    'SREStreamStart', 'DISPID_SRCEInterference', 'SpeechAllElements',
    'SVF_Stressed', 'SPSHT_Unknown',
    'DISPID_SVSLastStreamNumberQueued', 'SPSHT_NotOverriden',
    'DISPID_SpeechLexiconWord', 'SPSModifier',
    'DISPID_SRCEEnginePrivate', 'SpeechPartOfSpeech',
    'SAFTExtendedAudioFormat', 'SRTAutopause', 'SpeechMicTraining',
    'SpeechSpecialTransitionType', 'SGSExclusive',
    'ISpObjectWithToken', 'DISPID_SRRecognizer', 'DISPID_SGRSTType',
    ...
    'SAFTADPCM_44kHzMono', 'SVEVoiceChange', 'SAFTGSM610_22kHzMono',
    'DISPID_SLPPartOfSpeech', 'SPPS_RESERVED2', 'SPWT_PRONUNCIATION',
    'DISPID_SDKGetStringValue', 'SPCT_SUB_DICTATION',
    'SAFTCCITT_ALaw_22kHzStereo', 'eLEXTYPE_PRIVATE4',
    'eLEXTYPE_RESERVED10', 'ISpeechGrammarRuleStateTransition',
    'DISPID_SRCPause', 'DISPID_SRStatus', 'eLEXTYPE_PRIVATE20',
    '_ISpeechVoiceEvents', 'SRATopLevel', 'ISpeechPhraseInfo',
    'DISPID_SRGDictationUnload', 'SpeechAudioProperties',
    'SPEI_RESERVED6', 'SRADefaultToActive', 'SASClosed',
    'DISPID_SLWType', 'SITooLoud', 'DISPID_SRCEAdaptation',
    'SPEI_RESERVED3', 'SRSActiveAlways',
    'DISPID_SOTMatchesAttributes', 'SPRULESTATE', 'SPGRAMMARSTATE',
    'DISPID_SWFEExtraData', 'DISPID_SRRGetXMLResult',
    'DISPID_SASFreeBufferSpace', 'DISPID_SRRSetTextFeedback',
    'ISpeechGrammarRules', 'ISpeechGrammarRuleStateTransitions',
    'eLEXTYPE_APP', 'ISpeechPhraseAlternate', 'SpeechTokenValueCLSID',
    'SpeechAudioFormatGUIDText', 'ISpResourceManager',
    'DISPID_SVSInputSentencePosition', 'eLEXTYPE_PRIVATE1',
    'SPEI_TTS_PRIVATE', 'SPPS_NotOverriden', 'DISPID_SRCESoundStart',
    'SAFT22kHz16BitMono', 'DISPID_SpeechPhraseInfo', 'SpWaveFormatEx',
    'DISPID_SLAddPronunciation', 'DISPID_SPEEngineConfidence',
    'SPPHRASERULE', 'DISPID_SLWLangId', 'SpeechRuleAttributes',
    'DISPID_SMSALineId', 'DISPID_SGRSTsItem', 'SPDKL_DefaultLocation',
    'DISPID_SLGetWords', 'ISpeechPhoneConverter',
    'SAFT11kHz16BitStereo', 'SAFTADPCM_8kHzStereo',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SLWsCount', 'SVEViseme',
    'SVEBookmark', 'SPEVENTSOURCEINFO', 'eLEXTYPE_USER_SHORTCUT',
    'SRTStandard', 'STSF_AppData', 'DISPID_SPRuleId', 'SVP_16',
    'DISPID_SpeechLexiconPronunciation', 'SpeechDataKeyLocation',
    'SpVoice', 'ISpProperties', 'DISPID_SVEStreamEnd',
    'DISPID_SDKSetBinaryValue', 'eLEXTYPE_LETTERTOSOUND',
    'SPEI_MAX_TTS', 'DISPID_SASCurrentSeekPosition',
    'SpeechCategoryRecognizers', 'SPPROPERTYINFO',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SPEVENT',
    'SPSHT_OTHER', 'DISPID_SRCRequestedUIType', 'SpeechRunState',
    'DISPID_SVSInputWordPosition', 'SAFT16kHz16BitMono',
    'DISPID_SDKSetLongValue', 'SPEI_REQUEST_UI',
    'DISPID_SLGetGenerationChange', 'DISPID_SGRsCount', 'ISpPhrase',
    'DISPID_SRCEPhraseStart', 'DISPID_SGRSTNextState', 'SPEI_VISEME',
    'DISPID_SPPsItem', 'DISPID_SVEVoiceChange',
    'SpeechGrammarTagWildcard', 'SAFTCCITT_ALaw_8kHzMono',
    'SPAUDIOOPTIONS', 'DISPID_SRSCurrentStreamPosition',
    'SPPS_Unknown', 'DISPID_SpeechXMLRecoResult', 'SPEI_MIN_SR',
    'SAFTCCITT_ALaw_11kHzMono', 'SpTextSelectionInformation',
    'SPTEXTSELECTIONINFO', 'ISpAudio', 'SVP_7', 'SPEI_TTS_BOOKMARK',
    'eWORDTYPE_ADDED', 'SGRSTTRule', 'ISpPhoneticAlphabetConverter',
    'SpeechRetainedAudioOptions', 'DISPID_SVEEnginePrivate',
    'DISPID_SRSNumberOfActiveRules', 'SPAR_High',
    ...
    'DISPID_SRCERequestUI', 'IEnumString', 'SpeechLexiconType',
    'SP_VISEME_1', 'SP_VISEME_21', 'DISPID_SpeechAudioFormat',
    'IStream', 'eLEXTYPE_RESERVED6', 'SSSPTRelativeToStart',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SRCEBookmark',
    'ISpeechRecognizer', 'DISPID_SPRuleParent', 'STSF_LocalAppData',
    'ISpeechAudioStatus', 'eLEXTYPE_RESERVED4',
    'DISPID_SGRSTransitions', 'SECLowConfidence',
    'SPRECOGNIZERSTATUS', 'SFTInput', 'ISpPhoneConverter',
    'DISPID_SRRSaveToMemory', 'SPPARTOFSPEECH', 'SFTSREngine',
    'SGDSActiveUserDelimited', 'DISPID_SRIsShared',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SPAR_Low',
    'SPBINARYGRAMMAR', 'ISpeechPhraseReplacements', 'SPCT_COMMAND',
    'DISPID_SABIEventBias', 'SpeechRecoProfileProperties',
    'SAFT8kHz8BitStereo', 'SPEI_SR_BOOKMARK', 'SVP_13', 'SPAS_RUN',
    'DISPID_SPEsItem', 'DISPID_SpeechRecoContext', 'SVSFParseMask',
    'DISPID_SRCEStartStream', 'DISPID_SRGDictationLoad', 'SPWORD',
    'SpeechRecoEvents', 'SDTReplacement',
    'DISPID_SASCurrentDevicePosition', 'SPRECOSTATE', 'SVP_3',
    'ISpRecoGrammar2', 'SpeechRecognizerState',
    'SAFTNonStandardFormat', 'SAFTCCITT_uLaw_11kHzStereo',
    'ISpeechRecoContext', 'SPPS_Modifier',
    'SPEI_PROPERTY_STRING_CHANGE',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SpeechObjectToken',
    'DISPID_SpeechDataKey', 'SITooFast', 'SpLexicon',
    'SAFT32kHz8BitMono', 'SPAO_RETAIN_AUDIO',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SWFEBitsPerSample',
    'DISPID_SVGetVoices', 'SVSFIsFilename', 'SVEStartInputStream',
    'SP_VISEME_0', 'SpeechAudioFormatGUIDWave', 'SGLexical',
    'SPEI_ADAPTATION', 'SINoSignal', 'SPWAVEFORMATTYPE',
    'SPLO_DYNAMIC', 'SPPS_Verb', 'STCAll', 'DISPID_SVGetAudioInputs',
    'SP_VISEME_7', 'DISPID_SPRuleName', 'SPSFunction',
    'DISPID_SPRNumberOfElements', 'SVSFParseAutodetect',
    'SGPronounciation', 'SVP_2', 'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SWFEFormatTag', 'SVEAllEvents', 'ISpSerializeState',
    'SGDisplay', 'DISPID_SVIsUISupported', 'SAFTGSM610_8kHzMono',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SGRSTWeight',
    'ISpStreamFormat', 'SPINTERFERENCE_NOSIGNAL', 'SPCS_ENABLED',
    'SPEI_FALSE_RECOGNITION', 'SPPS_RESERVED4',
    'SAFT44kHz16BitStereo', 'ISpeechLexiconPronunciation',
    'DISPID_SGRsDynamic', 'SpeechCategoryPhoneConverters',
    'SpeechTokenKeyUI', 'SP_VISEME_12', 'DISPID_SRCEHypothesis',
    'SPRECOCONTEXTSTATUS', 'ISpeechFileStream', 'DISPID_SRGState',
    'SPAUDIOBUFFERINFO', 'SPDKL_LocalMachine', 'SPPHRASEREPLACEMENT',
    ...
    'DISPID_SPRsCount', 'Speech_Default_Weight', 'SPSVerb',
    'Speech_StreamPos_RealTime', 'DISPID_SGRsCommit',
    'SRERecognition', 'SVSFIsNotXML', 'DISPID_SVPriority',
    '_SPAUDIOSTATE', 'DISPID_SPRuleEngineConfidence',
    'DISPID_SVSPhonemeId', 'SpeechPropertyHighConfidenceThreshold',
    'SP_VISEME_4', 'SpNullPhoneConverter', 'DISPID_SLWsItem',
    'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SDKGetlongValue', 'SPAS_STOP', 'SP_VISEME_10',
    'SRSEIsSpeaking', 'DISPID_SpeechPhraseReplacements',
    'DISPID_SpeechLexicon', 'DISPID_SMSADeviceId', 'DISPID_SVSkip',
    'DISPID_SWFEAvgBytesPerSec', 'SPEI_MIN_TTS', 'ISpEventSource',
    'DISPID_SVEViseme', 'SGLexicalNoSpecialChars', 'SVP_19',
    'DISPID_SRCRetainedAudioFormat', 'SpeechFormatType',
    'DISPID_SVEPhoneme', 'DISPID_SpeechPhraseElement',
    'SPEI_RESERVED2', 'DISPID_SPRuleNumberOfElements',
    ...
    'DISPID_SRGCmdLoadFromFile', 'SP_VISEME_18', 'SpAudioFormat',
    'DISPID_SVSLastBookmarkId', 'SDTAudio', 'DISPID_SGRsItem',
    'DISPID_SPERequiredConfidence', 'ISpeechWaveFormatEx',
    'ISpRecoContext', 'SAFT44kHz8BitMono', 'DISPID_SOTRemove',
    'SPEI_SOUND_END', 'SAFT22kHz16BitStereo',
    ...
    'SpeechInterference', 'SPFM_CREATE', 'SPWT_LEXICAL',
    'DISPID_SPRText', 'DISPID_SpeechPhraseProperties', 'ISpPhraseAlt',
    'ISpeechPhraseRules', 'DISPID_SVWaitUntilDone',
    'DISPID_SVAudioOutput', 'SPSERIALIZEDRESULT',
    'SAFTGSM610_44kHzMono', 'DISPID_SPPEngineConfidence', 'SVP_10',
    'DISPID_SpeechPhraseBuilder', 'SPEI_RECO_OTHER_CONTEXT',
    'DISPID_SpeechGrammarRule', 'DISPID_SpeechGrammarRules',
    'ISpVoice', 'SBONone', 'SpeechTokenKeyAttributes',
    'SpObjectToken', 'ISpeechRecoGrammar', 'ISpeechMemoryStream',
    'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SVGetProfiles',
    'SPWF_INPUT', 'SpeechRecognitionType', 'DISPID_SOTsItem',
    'SRERequestUI', 'DISPID_SPIEngineId',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SOTGetStorageFileName',
    'SAFT48kHz8BitMono', 'DISPID_SPISaveToMemory', 'SVP_5',
    'DISPID_SBSRead', 'SREStateChange',
    'ISpPhoneticAlphabetSelection', 'ISpeechPhraseReplacement',
    'SASRun', 'DISPID_SRCState', 'SP_VISEME_14', 'SDTDisplayText',
    ...
    'DISPID_SPRulesItem', 'SPRST_INACTIVE', 'DISPID_SPEs_NewEnum',
    'DISPID_SGRs_NewEnum', 'SECFIgnoreWidth',
    'SpeechPropertyResourceUsage', 'DISPID_SRSetPropertyNumber',
    'SAFT8kHz16BitMono', 'DISPID_SVDisplayUI', 'SPSEMANTICERRORINFO',
    'DISPID_SPRsItem', 'ISpeechPhraseAlternates', 'SVP_4',
    'DISPID_SAVolume', 'DISPID_SPRs_NewEnum', 'DISPID_SRRAudio',
    'DISPID_SRSAudioStatus', 'ISpeechMMSysAudio',
    'SpPhraseInfoBuilder', 'SWTDeleted', 'SPRS_ACTIVE_USER_DELIMITED',
    'DISPID_SRGetPropertyString', 'SRAImport',
    'DISPID_SRGRecoContext', 'SpInprocRecognizer',
    ...
    'DISPID_SDKEnumKeys', 'eLEXTYPE_PRIVATE9', 'SAFT48kHz16BitStereo',
    'SPEI_INTERFERENCE', 'SREBookmark', 'ISpDataKey',
    'DISPID_SLWPronunciations', 'DISPID_SGRAttributes',
    'ISpeechPhraseProperty', 'DISPID_SPIGetDisplayAttributes',
    'SLODynamic', 'SPSNotOverriden', 'DISPID_SPERetainedStreamOffset',
    'SPFM_OPEN_READWRITE', 'SBOPause', 'tagSPTEXTSELECTIONINFO',
    'DISPID_SRRAlternates', 'SSFMCreate', 'SAFTADPCM_22kHzStereo',
    'ISpeechGrammarRule', 'SpSharedRecognizer',
    'DISPID_SPPConfidence', 'SpeechLoadOption', 'SVP_8',
    'SPPS_Interjection', 'ISpXMLRecoResult', 'DISPID_SVEBookmark',
    'SpSharedRecoContext', 'DISPID_SPACommit', 'SPSTREAMFORMATTYPE',
    'SREPropertyStringChange', 'SRAInterpreter', 'SPLOADOPTIONS',
    'ISpeechVoiceStatus', 'SAFTCCITT_ALaw_44kHzMono',
    'SPSHORTCUTPAIRLIST', 'SPAO_NONE', 'DISPIDSPTSI',
    'SAFT16kHz16BitStereo', 'SpNotifyTranslator',
    'ISpeechLexiconPronunciations', 'SAFTADPCM_11kHzMono',
    'DISPID_SVStatus', 'SPFM_CREATE_ALWAYS', 'SPVISEMES',
    'DISPID_SRState', 'SRAExport', 'SpMMAudioIn', 'SGRSTTTextBuffer',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SGRClear',
    'DISPID_SGRAddResource', 'DISPID_SPPValue', 'DISPID_SVSVisemeId',
    'eLEXTYPE_USER', 'SAFT44kHz16BitMono', 'SVEPhoneme',
    'SPFM_OPEN_READONLY', 'SVSFParseSapi', 'SpeechCategoryVoices',
    'SPRECORESULTTIMES', 'SPGS_DISABLED', 'DISPID_SpeechVoiceEvent',
    'SRARoot', 'SVP_21', 'WAVEFORMATEX', 'DISPID_SPPNumberOfElements',
    'SPEI_RESERVED1', 'eLEXTYPE_PRIVATE6',
    'DISPID_SRCSetAdaptationData', 'SpeechVoiceEvents',
    'SpeechAddRemoveWord', 'DISPID_SASNonBlockingIO',
    'SPDKL_CurrentConfig', 'DISPID_SGRSTPropertyName',
    'eLEXTYPE_PRIVATE19', 'SpeechAudioVolume', 'eLEXTYPE_PRIVATE17',
    'SPPS_RESERVED1', 'SAFT12kHz8BitMono', 'SPSERIALIZEDPHRASE',
    'SAFTCCITT_ALaw_44kHzStereo', 'SREPhraseStart', 'ISpRecoContext2',
    ...
    'ISpeechRecoResultTimes', 'SASPause', 'UINT_PTR', 'SPPS_Noun',
    'SPRST_NUM_STATES', 'SPEI_TTS_AUDIO_LEVEL', 'SREHypothesis',
    'DISPID_SDKOpenKey', 'SpeechStreamFileMode', 'SPEI_SOUND_START',
    'DISPID_SpeechPhraseRules', 'ISpRecoResult', 'DISPID_SGRSTText',
    'DISPID_SVSRunningState', 'ISpObjectToken',
    'SpeechGrammarWordType', 'SRAONone', 'SPINTERFERENCE_TOOSLOW',
    'DISPID_SOTCategory', 'DISPID_SRCERecognizerStateChange',
    'SPSHORTCUTTYPE', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SpeechTokenIdUserLexicon', 'SpeechDiscardType',
    'SpeechTokenContext', 'DISPID_SPPChildren', 'SINone',
    'DISPID_SPAsCount', 'SPEI_UNDEFINED',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SpMMAudioEnum',
    'DISPID_SVSCurrentStreamNumber', 'SAFTADPCM_8kHzMono',
    ...
    'STSF_FlagCreate', 'SpStreamFormatConverter',
    'DISPID_SVEventInterests', 'SRESoundEnd', 'DISPID_SPRulesCount',
    'IEnumSpObjectTokens', 'SpPhoneConverter', 'SAFT32kHz16BitStereo',
    'DISPID_SPPBRestorePhraseFromMemory', 'SVP_14',
    'SAFT12kHz8BitStereo', 'SREPropertyNumChange',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SRCVoice',
    'DISPID_SPCLangId', 'Speech_Max_Word_Length',
    'SPADAPTATIONRELEVANCE', 'IInternetSecurityManager',
    'DISPID_SPPName', 'SECNormalConfidence', 'ISpeechRecoResult2',
    'SP_VISEME_3', 'SPEI_VOICE_CHANGE', 'DISPID_SPRFirstElement',
    'DISPID_SpeechFileStream', 'SPAUDIOSTATE', 'SPCT_SLEEP',
    'SECFDefault', 'SPSLMA', 'DISPID_SpeechRecognizerStatus',
    'DISPIDSPTSI_SelectionLength', 'SAFT24kHz8BitMono',
    'SPINTERFERENCE_NONE', 'DISPID_SPAPhraseInfo', 'DISPID_SLPsItem',
    'SpeechDisplayAttributes', 'SWPKnownWordPronounceable',
    'SPEI_SENTENCE_BOUNDARY', 'SPSSuppressWord',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SGRSRule', 'DISPIDSPTSI_ActiveOffset', 'DISPID_SRGId',
    'SpeechWordType', 'SRCS_Disabled', 'SRCS_Enabled', 'SDTAll',
    'SAFTCCITT_uLaw_44kHzMono', 'SPBOOKMARKOPTIONS', 'SPRS_INACTIVE',
    'SGRSTTWildcard', 'DISPID_SRCESoundEnd',
    'DISPID_SpeechBaseStream', 'SVSFIsXML', 'ISpeechXMLRecoResult',
    'DISPID_SRGSetWordSequenceData', 'ISpeechCustomStream',
    'SSFMOpenReadWrite', 'SDTRule', 'DISPID_SGRInitialState',
    'SPEI_PHONEME', 'DISPID_SAFGetWaveFormatEx', 'SP_VISEME_16',
    'SVP_20', 'DISPID_SBSSeek', 'SDA_No_Trailing_Space',
    'DISPID_SADefaultFormat', 'DISPID_SMSSetData',
    'SAFT11kHz8BitStereo', 'ISpRecognizer', 'SpeechGrammarState',
    'SPRULE', 'SPINTERFERENCE', 'SP_VISEME_6', 'SPLEXICONTYPE',
    'SVP_9', 'DISPID_SLPPhoneIds', 'DISPID_SPRuleFirstElement',
    'SpeechGrammarRuleStateTransitionType',
    'DISPID_SpeechPhraseProperty', 'SVP_6', 'SAFT44kHz8BitStereo',
    'SPWORDPRONUNCIATIONLIST', 'SGDSInactive', 'DISPID_SABufferInfo',
    'SpeechUserTraining', 'SPSMF_SAPI_PROPERTIES',
    'eWORDTYPE_DELETED', 'ISpGrammarBuilder', 'SSTTWildcard',
    'SAFTCCITT_uLaw_8kHzMono', 'SpeechRecoContextState',
    'DISPID_SPPsCount', 'DISPID_SRSetPropertyString',
    'SAFT32kHz8BitStereo', 'SPVPRIORITY', 'SDTPronunciation',
    'SAFTGSM610_11kHzMono', 'DISPID_SGRSTPropertyId', 'SAFTText',
    'SPEI_WORD_BOUNDARY', 'SPRST_ACTIVE', 'SAFT48kHz8BitStereo',
    'eLEXTYPE_PRIVATE16', 'ISpLexicon', 'SECFIgnoreKanaType',
    'SPGS_ENABLED', 'DISPID_SDKDeleteKey', 'SREAllEvents',
    'SVSFUnusedFlags', 'SREPrivate', 'eLEXTYPE_PRIVATE18',
    'DISPID_SpeechMemoryStream', 'SPXMLRESULTOPTIONS',
    'SpMemoryStream', 'DISPID_SRGCmdSetRuleState', 'SPPHRASEPROPERTY',
    'SVSFNLPSpeakPunc', 'DISPID_SVESentenceBoundary',
    'SREFalseRecognition', 'SpeechPropertyNormalConfidenceThreshold',
    'SVSFVoiceMask', 'DISPID_SLWWord', 'SPEI_END_SR_STREAM',
    'eLEXTYPE_VENDORLEXICON', 'SDKLLocalMachine', 'SRADynamic',
    'ISpMMSysAudio', 'tagSTATSTG', 'DISPID_SOTGetDescription',
    'SPAR_Unknown', 'ISpRecognizer3', 'SGRSTTEpsilon', 'SVP_0',
    'SVEPrivate', 'SpCustomStream', 'SPVPRI_ALERT', 'SSTTTextBuffer',
    'ISpeechLexiconWord', 'ISpRecoCategory', 'DISPID_SRRTTickCount',
    'SPINTERFERENCE_TOOLOUD', 'SPPS_LMA', 'SAFT8kHz16BitStereo',
    'DISPID_SAFType', 'SP_VISEME_11', 'SGDSActiveWithAutoPause',
    'DISPID_SVPause', 'SpShortcut', 'SPEI_RECO_STATE_CHANGE',
    'SINoise', 'ISequentialStream', 'DISPID_SLGenerationId',
    'eLEXTYPE_PRIVATE13', 'SAFT16kHz8BitMono', 'SVP_11',
    'SAFT24kHz16BitMono', 'SPPS_Function', 'DISPID_SpeechMMSysAudio',
    'SPAS_CLOSED', 'SPBO_NONE', 'SpeechEmulationCompareFlags',
    'SPEI_MAX_SR', 'SAFTCCITT_uLaw_11kHzMono', 'SPBO_TIME_UNITS',
    'LONG_PTR', 'SpeechRegistryUserRoot', 'SVF_Emphasis',
    'DISPID_SPARecoResult', 'DISPID_SGRSTs_NewEnum',
    'DISPID_SpeechRecoContextEvents', 'SAFTCCITT_uLaw_22kHzStereo',
    'SPWORDTYPE', 'DISPID_SPIGetText', 'SpeechPropertyAdaptationOn',
    'SPEI_RECOGNITION', 'SpFileStream', 'SpeechVoicePriority',
    'DISPID_SCSBaseStream', 'DISPID_SpeechLexiconWords',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SRCVoicePurgeEvent',
    'ISpNotifySink', 'DISPID_SGRAddState', 'SLTApp', 'SVPOver',
    'tagSPPROPERTYINFO', 'DISPID_SRIsUISupported',
    'eLEXTYPE_RESERVED9', 'DISPID_SRGCmdSetRuleIdState',
    'eLEXTYPE_MORPHOLOGY', 'DISPID_SPEDisplayAttributes',
    'SSSPTRelativeToEnd', 'IInternetSecurityMgrSite',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SRRGetXMLErrorInfo',
    'ISpeechAudio', 'ISpNotifyTranslator', 'DISPID_SpeechRecoResult2',
    'DISPID_SRDisplayUI', 'DISPID_SOTIsUISupported', 'SVP_12',
    'DISPID_SRRTLength', 'STSF_CommonAppData',
    'SPEI_SR_RETAINEDAUDIO', 'eLEXTYPE_PRIVATE5',
    'DISPID_SRCEventInterests', 'DISPID_SPRuleChildren',
    'DISPID_SRGReset', 'DISPID_SMSGetData', 'DISPID_SVSLastResult',
    'DISPID_SGRId', 'DISPID_SRAudioInputStream',
    'SDA_Consume_Leading_Spaces',
    'SpeechPropertyComplexResponseSpeed', 'SpeechCategoryAudioIn',
    'SPWORDPRONUNCIATION', 'SPSMF_UPS', 'DISPIDSPTSI_SelectionOffset',
    'SAFT12kHz16BitStereo', 'DISPID_SWFEChannels', 'DISPID_SOTCId',
    'DISPID_SLPs_NewEnum', 'SPAS_PAUSE', 'SAFT22kHz8BitMono',
    'DISPID_SRCRetainedAudio', 'SpMMAudioOut', 'SPAUDIOSTATUS',
    'SpResourceManager', 'DISPID_SDKGetBinaryValue',
    'SPSInterjection', 'SpeechRegistryLocalMachineRoot',
    'DISPID_SpeechRecognizer', 'SPEI_HYPOTHESIS',
    'DISPID_SOTCGetDataKey', 'SPSNoun',
    'DISPID_SGRSAddRuleTransition', 'SPSEMANTICFORMAT',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SOTId',
    'DISPID_SWFESamplesPerSec', 'SPEI_PROPERTY_NUM_CHANGE',
    'SPCT_SUB_COMMAND', 'DISPID_SRRSpeakAudio', 'DISPID_SBSWrite',
    'DISPID_SRCBookmark', 'SPRST_INACTIVE_WITH_PURGE',
    'ISpeechLexiconWords', 'DISPID_SRGIsPronounceable',
    'DISPID_SPIReplacements', 'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SRSCurrentStreamNumber', 'SPRS_ACTIVE', 'DISPID_SVVolume',
    'SDA_One_Trailing_Space', 'DISPID_SRGRules',
    'DISPID_SVSInputWordLength', 'DISPID_SPILanguageId',
    'SVSFPersistXML', 'SAFTNoAssignedFormat', 'SAFT24kHz16BitStereo',
    'DISPID_SOTDisplayUI', 'DISPID_SRRTOffsetFromStart',
    'DISPID_SLPLangId', 'SVP_17', 'SAFT11kHz8BitMono', 'SVPNormal',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SVVoice',
    'SPINTERFERENCE_TOOQUIET'
]

_check_version('1.2.0', 1698749426.362920)
